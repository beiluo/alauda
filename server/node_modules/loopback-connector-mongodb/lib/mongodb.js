...
function generateMongoDBURL(options) {
  ...
  if (username && options.password) {
    return "mongodb://" + username + ":" + options.password + "@" + options.hostname + ":" + options.port + "/" + options.database+"?maxPoolSize=1000";
  } else {
    return "mongodb://" + options.hostname + ":" + options.port + "/" + options.database+"?maxPoolSize=1000";
  }
}
